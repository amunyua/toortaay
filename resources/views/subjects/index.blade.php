            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Subjects</h4>
                    </div>
                    <div class="modal-body">
                         <p>Are you sure you want to delete this Subjects?</p>
                    </div>
               ...
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="modal-header">
                           ...
                           <h4 class="modal-title">Create Subjects</h4>
                       </div>
                       <div class="modal-body">
           ...
           <form method="post" id="edit-form">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                         <input type="hidden" id="editDetails" value="{{ url("/subjects") }}">
                        <button type="button" class="btn btn-simple" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-simple">Save</button>
                    </div>
                </div>
