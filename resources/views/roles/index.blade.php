...
@section('content')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Roles</h4>
                    </div>
       ...
       {{--delete-modal--}}
       <div class="modal fade" id="assign-permissions-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           <div class="modal-dialog">
               <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   ...
                   <div class="modal-body">
                       <div class="row">
                           <div class="col-md-12">
                               <table class="table" id="permissions" style="width: 100%">
                                   <thead>
                                   <tr>
                                       <td>Url</td>
                                       <td>Action</td>
                   ...
                   <div class="modal-footer">
                       ...
                       <input type="hidden" id="permissions-route" value="{{ url('getPermissions') }}">
                       <button type="button" class="btn btn-simple btn-success" data-dismiss="modal">Done</button>
                       {{--<button type="submit" class="btn btn-simple">Save</button>--}}
                   </div>
               </div>
           </div>
