            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Pupil</h4>
                    </div>
                    <div class="modal-body">
                         <p>Are you sure you want to delete this Pupils?</p>
                    </div>
               ...
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="modal-header">
                           ...
                           <h4 class="modal-title">Create Pupil</h4>
                       </div>
                       <div class="modal-body">
           ...
           <form method="post" id="edit-form">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                         <input type="hidden" id="editDetails" value="{{ url("/pupils") }}">
                        <button type="button" class="btn btn-simple" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-simple">Save</button>
                    </div>
                </div>
